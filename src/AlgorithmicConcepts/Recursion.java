...
public class Recursion {
    ...
    // Recursive case – the conditions under which
    //                  the method will perform an action and call itself
    // Base case – the conditions under which
    //             the method returns a value
    //             without making any additional calls to itself
